...
print("Kernel booted! Sending 'run help.exe'...")
output = ""
send_keys("run help.exe\n")

# Wait longer for all the debug output
time.sleep(20)
read_output()
...
print("=" * 70)
print("OUTPUT after 'run help.exe':")
print("=" * 70)
# Print the cleaned output, splitting on our field separator
lines = cleaned.split('\n')
for line in lines:
