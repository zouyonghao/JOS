...
class QEMUPETest:
    ...
    def run(self):
        ...
        try:
            ...
            if "win_hello.exe" in self.output:
                output_lines.append("✓ win_hello.exe found in filesystem")
            else:
                output_lines.append("✗ win_hello.exe NOT found")
                output_lines.append("")
                ...
                return (False, "win_hello.exe not found in filesystem", "\n".join(output_lines))
            ...
            # Run the PE file
            output_lines.append("")
            output_lines.append("Sending 'run win_hello.exe' command...")
            self._send_keys("run win_hello.exe\n")
            ...
            if "Hello from Windows PE" in output:
